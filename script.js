  ...
  if(!modalVisible){
   ...
   modal.innerHTML=`  
                    ...
                    <div class="modal-priority-list">
                        ...
                        <div class="modal-pink modal-filter active"></div>
                        <div class="modal-blue modal-filter"></div>
                        <div class="modal-green modal-filter"></div>
                        <div class="modal-yellow modal-filter"></div>
...
taskModal.addEventListener("click", function(e) {
  ...
  function selectPriority(taskModal,e){
    ...
    e.currentTarget.classList.add("active");
    taskModal.click(); //to prevent empty ticket
    taskModal.focus();
  }
   ...
   { 
     ...
     let id=uid();
      ...
      {
        let data=[{
          "ticketId":id, "task":task,"priority":selectedPriority
        }];
    ...
    if(activeFilter)
    {
     ...
     {
       e.preventDefault();
       alert("Error! have not typed anything");
     }
